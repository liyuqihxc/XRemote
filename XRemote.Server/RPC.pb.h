...
class RpcInvoke : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:RPC.RpcInvoke) */ {
 public:
  ...
  ::google::protobuf::int32 proxyid() const;
  void set_proxyid(::google::protobuf::int32 value);
 ...
 private:
  ...
  ::google::protobuf::int32 proxyid_;
...
// sfixed32 ProxyID = 1;
inline void RpcInvoke::clear_proxyid() {
  proxyid_ = 0;
}
inline ::google::protobuf::int32 RpcInvoke::proxyid() const {
  // @@protoc_insertion_point(field_get:RPC.RpcInvoke.ProxyID)
  return proxyid_;
}
inline void RpcInvoke::set_proxyid(::google::protobuf::int32 value) {
