...
namespace RPC {
    ...
    static RPCReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "IoQBCglScGNJbnZva2USDwoHUHJveHlJRBgBIAEoDxITCgtJbnRlcmZhY2VJ",
            "RBgCIAEoBxIOCgZDYWxsSUQYAyABKA8SDgoGRGlzcElEGAQgASgFEg4KBndG",
            "bGFncxgFIAEoBRIhCgZQYXJhbXMYBiADKAsyES5SUEMuVmFyaWFudFBhcmFt",
            "IscBCglScGNSZXR1cm4SDgoGQ2FsbElEGAEgASgPEg8KB0hSZXN1bHQYAiAB",
            "KA8SJAoJUmV0dXJuVmFsGAMgASgLMhEuUlBDLlZhcmlhbnRQYXJhbRIvCglF",
            "eGNlcHRpb24YBCABKAsyHC5SUEMuUnBjUmV0dXJuLkV4Y2VwdGlvbkluZm8a",
            "QgoNRXhjZXB0aW9uSW5mbxITCgtEZXNjcmlwdGlvbhgBIAEoCRINCgVzY29k",
            "ZRgCIAEoBRINCgV3Q29kZRgDIAEoBTIUChJSZW1vdGVDbGFzc0ZhY3RvcnlC",
            "AkgCYgZwcm90bzM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::RPC.RpcInvoke), global::RPC.RpcInvoke.Parser, new[]{ "ProxyID", "InterfaceID", "CallID", "DispID", "WFlags", "Params" }, null, null, null),
  ...
  public sealed partial class RpcInvoke : pb::IMessage<RpcInvoke> {
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (ProxyID != 0) hash ^= ProxyID.GetHashCode();
